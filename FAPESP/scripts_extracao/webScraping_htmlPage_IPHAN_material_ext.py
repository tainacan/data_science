...
#Definindo variáveis
colunas          = ['Recorte territorial', 'Recorte temático', 'Identificação do universo', 'UF', 'Município', 'CEP', 'Coordenada(s) geográfica(s)', 'Endereço',
                    'Nome', 'Nome popular', 'Natureza', 'Tipo', 'Estado de Conservação', 'Estado de Preservação', 'Uso do Solo', 'Entorno do bem', 'Síntese',
                    'Síntese histórica', 'Meios de acesso ao bem', 'Outras Informações','Página']
